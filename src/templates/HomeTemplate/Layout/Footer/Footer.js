...
export default function Footer() {
  ...
  return (
    <div className="mt-10">
      <footer className="py-6 dark:bg-coolGray-800 dark:text-coolGray-50 bg-gray-200">
        <div className="container px-6 mx-auto space-y-6 divide-y divide-coolGray-400 md:space-y-12 divide-opacity-50">
          <div className="grid grid-cols-12">
            <div className="pb-6 col-span-full md:pb-0 md:col-span-6">
              ...
              >
                <div className="flex items-center justify-center w-12 h-12 rounded-full dark:bg-violet-400 text-black">
                  <svg
            ...
            <div className="col-span-6 text-center md:text-left md:col-span-3">
              <p className="pb-1 text-lg font-medium font-bold">He Thong Rap</p>
              <ul className="grid grid-cols-3">
                {arrHeThongRap.map((htr,index)=>{
                  return <li key={index} className='m-2'>
                    <img src={htr.logo} width={70} alt=''/>
                </li>
                })}
