...
export default function Header() {
  ...
  return (
    <header class="p-4  bg-black bg-opacity-40  text-white fixed w-full z-10">
      <div class="container flex justify-between h-16 mx-auto">
        ...
        <ul class="items-stretch hidden space-x-3 lg:flex">
          <li class="flex items-center text-white">
            <NavLink
              to="/home"
              class="flex items-center px-4 -mb-1 border-b-2 dark:border-transparent dark:border-violet-400 text-white "
              activeClassName="border-b-2 border-white align-middle flex items-center text-white"
            >
              Home
            </NavLink>
          </li>
        ...
        <button class="p-4 lg:hidden">
          ...
          >
            <path d="M4 6h16M4 12h16M4 18h16" strokeLinecap="butt"></path>
          </svg>
        </button>
      </div>
    </header>
